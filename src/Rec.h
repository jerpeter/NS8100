...
///
///	$Source: /Nomis_NS8100/ns7100_Port/source/Rec.h,v $
///	$Revision: 1.1 $
///----------------------------------------------------------------------------
...
#define MAX_NORMALIZED_SENSOR		4096
#define MIN_NORMALIZED_SENSOR		512
...
typedef struct
{
	...
	// Even if defined as 'uint8 unused[7]' will cause a size change in the trig_rec
	uint8 barChannel;
	uint8 barScale;
	int32 unused3;
