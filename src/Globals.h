...
extern uint16 g_preTrigBuff[PRE_TRIG_BUFF_SIZE_IN_WORDS];
...
extern uint16 g_currentEventBuffer;
extern SUMMARY_DATA g_summaryTable[MAX_RAM_SUMMARYS];
extern SUMMARY_DATA* g_lastCompletedRamSummary;
