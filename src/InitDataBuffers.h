...
#define EVENT_BUFF_SIZE_IN_WORDS_PLUS_EVT_RECORD_PLUS_SUMMARY_LIST	(EVENT_BUFF_SIZE_IN_WORDS_PLUS_EVT_RECORD + (0x80000 / 2))

#define SUMMARY_LIST_CACHE_OFFSET	(EVENT_BUFF_SIZE_IN_WORDS_PLUS_EVT_RECORD)
#define SUMMARY_LIST_CACHE_ENTRIES_LIMIT	5460 // 0x80000 / 96 bytes
