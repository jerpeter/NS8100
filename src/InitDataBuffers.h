...
#define LARGEST_QUARTERSEC_SIZE_IN_BYTES	(MAX_DATA_PER_SECOND / 4) // 32768 = MAX_DATA_PER_SECOND * 1/4 second
...
#define PRE_TRIG_BUFF_SIZE_IN_BYTES 	(LARGEST_QUARTERSEC_SIZE_IN_BYTES + MAX_DATA_PER_SAMPLE) // 1/4 second + 1 sample
#define PRE_TRIG_BUFF_SIZE_IN_WORDS 	(PRE_TRIG_BUFF_SIZE_IN_BYTES / 2)

#define EVENT_BUFF_SIZE_IN_BYTES    (LARGEST_EVENT_SIZE_IN_BYTES + LARGEST_QUARTERSEC_SIZE_IN_BYTES + LARGEST_CAL_SIZE_IN_BYTES + SPARE_SIZE_IN_BYTES)
