...
///
///	$Source: /Nomis_NS8100/ns7100_Port/source/Uart.c,v $
///	$Revision: 1.1 $
///----------------------------------------------------------------------------
...
/****************************************
*	Function:	btoa
*	Purpose:	Convert the byte ptr string
****************************************/
...
Function Name   :   craft
*********************************************************************
Description     :   formatted print function to the craft
Inputs          :   format...
Outputs         :   Total characters output
********************************************************************/
...
Function Name   :   debugPrint
		 Purpose:   print formatted debug informtion to the craft
********************************************************************/
...
/********************************************************************
Function Name   :   debugChar
		 Purpose:   print a char of debug informtion to the craft
********************************************************************/
