...
enum {
	...
	USBM_RI_8507_PLASTER_STANDARD,		// 2
	OSM_REGULATIONS_STANDARD,			// 3
	END_OF_VIBRATION_STANDARDS_LIST,	// 4
	START_OF_CUSTOM_CURVES_LIST = 9,
	CUSTOM_STEP_THRESHOLD,				// 10
	CUSTOM_STEP_LIMITING,				// 11
	END_OF_VIBRATION_CURVES_LIST		// 12
};
