...
enum {
	USBM_RI_8507_DRYWALL_STANDARD = 1,
	USBM_RI_8507_PLASTER_STANDARD,
	OSM_REGULATIONS_STANDARD,
	END_OF_VIBRATION_STANDARDS_LIST
};
...
typedef struct
{
	VARIABLE_TRIGGER_FREQ_CHANNEL_BUFFER r;
	VARIABLE_TRIGGER_FREQ_CHANNEL_BUFFER v;
	VARIABLE_TRIGGER_FREQ_CHANNEL_BUFFER t;
